...
# evaluation 'hmdb51' "dino_base_image" "timesformer_vit_base_patch16_224" "" "fgsm" -1 20 16 "all" "$None" "pretrained_video_models/timesformer/hmdb/8_div/results/checkpoint_epoch_00015.pyth"
