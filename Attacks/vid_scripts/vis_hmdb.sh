...
evaluation 'hmdb51' "dino_base_patch16_224_1P" "timesformer_vit_base_patch16_224"  "" "dim" -1 100 16 "all" "pretrained_video_models/transformation/1_8split_cat_prompt/hmdb/dino/8_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/timesformer/hmdb/8_div/results/checkpoint_epoch_00015.pyth"

# evaluation 'hmdb51' "clip_base_patch16_224_1P" "timesformer_vit_base_patch16_224"  "" "dim" -1 100 16 "all" "pretrained_video_models/transformation/1_8split_cat_prompt/hmdb/clip/8_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/timesformer/hmdb/8_div/results/checkpoint_epoch_00015.pyth"
