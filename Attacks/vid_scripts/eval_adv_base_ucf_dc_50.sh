...
for ITER in 50 100 500; do
  evaluation 'ucf101' "dino_base_patch16_224_1P" "timesformer_vit_base_patch16_224"  "" "dim" -1 "$ITER" 16 "all" "pretrained_video_models/transformation/1_8split_cat_prompt/ucf/dino/1_8_sample_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/timesformer/ucf/8_div/results/checkpoint_epoch_00015.pyth" "rce_{$ITER}"
done

for ITER in 50 100 500; do
  evaluation 'ucf101' "clip_base_patch16_224_1P" "timesformer_vit_base_patch16_224"  "" "dim" -1 "$ITER" 16 "all" "pretrained_video_models/transformation/1_8split_cat_prompt/ucf/clip/1_8_sample_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/timesformer/ucf/8_div/results/checkpoint_epoch_00015.pyth" "rce_{$ITER}"
done
