...
evaluation 'ucf101' "deit_base_patch16_224_timeP_1_cat" "timesformer_vit_base_patch16_224"  "" "dim" -1 300 16 "all" "pretrained_video_models/transformation/1_8split_cat_prompt/ucf/deit/8_224_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/timesformer/ucf/8_div/results/checkpoint_epoch_00015.pyth"

# evaluation 'ucf101' "clip_base_patch16_224_1P" "timesformer_vit_base_patch16_224"  "" "dim" -1 500 16 "all" "pretrained_video_models/transformation/1_8split_cat_prompt/ucf/clip/1_8_sample_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/timesformer/ucf/8_div/results/checkpoint_epoch_00015.pyth"

# evaluation 'ucf101' "dino_base_patch16_224_1P" "timesformer_vit_base_patch16_224"  "" "dim" -1 200 16 "all" "pretrained_video_models/transformation/1_8split_cat_prompt/ucf/dino/1_8_sample_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/timesformer/ucf/8_div/results/checkpoint_epoch_00015.pyth"
