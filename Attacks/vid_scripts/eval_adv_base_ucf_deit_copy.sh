...
for ATTACK in 'dim'; do
  evaluation 'ucf101' "deit_base_patch16_224_timeP_1_cat" "timesformer_vit_base_patch16_224"  "" "$ATTACK" -1 20 16 "all" "../timesformer/TimeSformer/train_output/196_cat_prompt/ucf/deit/8_4blocks/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/timesformer/ucf/8_div/results/checkpoint_epoch_00015.pyth"
done
