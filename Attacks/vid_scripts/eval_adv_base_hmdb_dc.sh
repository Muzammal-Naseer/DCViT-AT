...
evaluation 'hmdb51' "deit_base_patch16_224_timeP_1_cat" "timesformer_vit_base_patch16_224"  "" "dim" -1 "20" 16 "all" "../timesformer/TimeSformer/train_output/196_cat_full_finetune/hmdb/deit/8_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/timesformer/hmdb/8_div/results/checkpoint_epoch_00015.pyth" "hmdb_fulltune"

# for ITER in 20 50 100 500; do
#   evaluation 'ucf101' "clip_base_patch16_224_1P" "timesformer_vit_base_patch16_224"  "" "dim" -1 "$ITER" 16 "all" "pretrained_video_models/transformation/1_8split_cat_prompt/ucf/clip/1_8_sample_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/timesformer/ucf/8_div/results/checkpoint_epoch_00015.pyth" "logit_{$ITER}"
# done
