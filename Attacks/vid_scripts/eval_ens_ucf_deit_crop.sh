...
# evaluation 'ucf101' "deit_base_patch16_224_timeP_1_cat" "resnet_50"  "" "dim" -1 20 16 "all" "pretrained_video_models/transformation/1_8split_cat_prompt/ucf/deit/8_224_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/resnet_50/ucf/8_joint_1p/results/checkpoint_epoch_00030.pyth" "deit_base_patch16_224_timeP_1_cat" "deit_base_patch16_224_timeP_1_cat" "pretrained_video_models/transformation/1_8split_cat_prompt/ucf/deit/8_joint_1p_96/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/transformation/1_8split_cat_prompt/ucf/deit/8_224_56/results/checkpoint_epoch_00015.pyth"

evaluation 'ucf101' "deit_base_patch16_224_timeP_1_cat" "timesformer_vit_base_patch16_224"  "" "dim" -1 20 16 "all" "pretrained_video_models/transformation/1_8split_cat_prompt/ucf/deit/8_224_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/timesformer/ucf/8_div/results/checkpoint_epoch_00015.pyth" "deit_base_patch16_224_timeP_1_cat" "deit_base_patch16_224_timeP_1_cat" "pretrained_video_models/transformation/1_8split_cat_prompt/ucf/deit/8_joint_1p_96/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/transformation/1_8split_cat_prompt/ucf/deit/8_224_56/results/checkpoint_epoch_00015.pyth"
