...
for ATTACK in 'pgd'; do
  evaluation 'img3d_depth' "dino_base_patch16_224_1P" "mvcnn"  "" "$ATTACK" -1 20 16 "all" "pretrained_video_models/transformation/1_8split_cat_prompt/img3d_depth/dino/12_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/mvcnn/mvcnn_depth/model-00029.pth"
done
...
for ATTACK in 'pgd'; do
  evaluation 'img3d_depth' "clip_base_patch16_224_1P" "mvcnn"  "" "$ATTACK" -1 20 16 "all" "pretrained_video_models/transformation/1_8split_cat_prompt/img3d_depth/clip/12_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/mvcnn/mvcnn_depth/model-00029.pth"
done
