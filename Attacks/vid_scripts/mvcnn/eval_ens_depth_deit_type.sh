...
evaluation() {
  python eval_ens_mvcnn.py \
    --test_dir "../../../data/drive_2/multi_modal_data/Depth/*/test" \
    --data_type "$1" \
    --src_model_1 "$2" \
    --tar_model "$3" \
    --image_list "$4" \
...
evaluation 'img3d_depth' "deit_base_patch16_224_timeP_1_cat_ens" "mvcnn" "" "dim" -1 20 16 "all" "pretrained_video_models/transformation/1_8split_cat_prompt/img3d_depth/deit/12_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/mvcnn/mvcnn_depth/model-00029.pth" "dino_base_patch16_224_1P_ens" "clip_base_patch16_224_1P_ens" "pretrained_video_models/transformation/1_8split_cat_prompt/img3d_depth/dino/12_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/transformation/1_8split_cat_prompt/img3d_depth/clip/12_joint_1p/results/checkpoint_epoch_00015.pyth"
