...
# evaluation 'img3d_depth' "deit_base_image" "mvcnn" "" "fgsm" -1 20 16 "all" "$None" "pretrained_video_models/mvcnn/mvcnn_depth/model-00029.pth"
...
for ATTACK in 'mifgsm' 'pgd' 'fgsm'; do
  evaluation 'img3d_depth' "deit_small_image" "mvcnn" "" "$ATTACK" -1 20 16 "all" "$None" "pretrained_video_models/mvcnn/mvcnn_depth/model-00029.pth"
done

for ATTACK in 'mifgsm' 'pgd' 'fgsm'; do
  evaluation 'img3d_depth' "deit_tiny_image" "mvcnn" "" "$ATTACK" -1 20 16 "all" "$None" "pretrained_video_models/mvcnn/mvcnn_depth/model-00029.pth"
done
