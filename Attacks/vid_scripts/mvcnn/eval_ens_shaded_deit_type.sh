...
evaluation() {
  python eval_ens_mvcnn.py \
    --test_dir "../../../data/drive_2/multi_modal_data/Shaded/*/test" \
    --data_type "$1" \
    --src_model_1 "$2" \
    --tar_model "$3" \
    --image_list "$4" \
...
# evaluation 'ucf101' "deit_base_patch16_224_timeP_1_cat" "resnet_50"  "" "dim" -1 20 16 "all" "pretrained_video_models/transformation/1_8split_cat_prompt/ucf/deit/8_224_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/resnet_50/ucf/8_joint_1p/results/checkpoint_epoch_00030.pyth" "deit_small_patch16_224_timeP_1" "deit_tiny_patch16_224_timeP_1" "pretrained_video_models/transformation/1_8split_cat_prompt/ucf/deit_small/8_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/transformation/1_8split_cat_prompt/ucf/deit_tiny/8_joint_1p/results/checkpoint_epoch_00015.pyth"

evaluation 'img3d_shaded' "deit_base_patch16_224_timeP_1_cat_ens" "mvcnn" "" "dim" -1 20 16 "all" "pretrained_video_models/transformation/1_8split_cat_prompt/img3d_shaded/deit/12_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/mvcnn/mvcnn_shaded/model-00029.pth" "dino_base_patch16_224_1P_ens" "clip_base_patch16_224_1P_ens" "pretrained_video_models/transformation/1_8split_cat_prompt/img3d_shaded/dino/12_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/transformation/1_8split_cat_prompt/img3d_shaded/clip/12_joint_1p/results/checkpoint_epoch_00015.pyth"
