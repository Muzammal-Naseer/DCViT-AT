...
for ATTACK in 'mifgsm' 'pgd' 'fgsm'; do
  evaluation 'img3d_depth' "dino_base_image" "mvcnn" "" "$ATTACK" -1 20 16 "all" "$None" "pretrained_video_models/mvcnn/mvcnn_depth/model-00029.pth"
done

for ATTACK in 'mifgsm' 'pgd' 'fgsm'; do
  evaluation 'img3d_depth' "clip_base_image" "mvcnn" "" "$ATTACK" -1 20 16 "all" "$None" "pretrained_video_models/mvcnn/mvcnn_depth/model-00029.pth"
done
