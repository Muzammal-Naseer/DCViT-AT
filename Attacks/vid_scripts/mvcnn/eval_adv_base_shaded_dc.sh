...
for ATTACK in 'pgd'; do
  evaluation 'img3d_shaded' "dino_base_patch16_224_1P" "mvcnn"  "" "$ATTACK" -1 20 16 "all" "pretrained_video_models/transformation/1_8split_cat_prompt/img3d_shaded/dino/12_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/mvcnn/mvcnn_shaded/model-00029.pth"
done
# evaluation 'img3d_depth' "dino_base_patch16_224_1P" "mvcnn"  "" "fgsm" -1 20 16 "all" "pretrained_video_models/transformation/1_8split_cat_prompt/img3d_depth/dino/12_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/mvcnn/mvcnn_depth/model-00029.pth"
# evaluation 'img3d_depth' "dino_base_image" "mvcnn"  "" "dim" -1 20 16 "all" "$None" "pretrained_video_models/mvcnn/mvcnn_depth/model-00029.pth"

for ATTACK in 'pgd'; do
  evaluation 'img3d_shaded' "clip_base_patch16_224_1P" "mvcnn"  "" "$ATTACK" -1 20 16 "all" "pretrained_video_models/transformation/1_8split_cat_prompt/img3d_shaded/clip/12_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/mvcnn/mvcnn_shaded/model-00029.pth"
done
