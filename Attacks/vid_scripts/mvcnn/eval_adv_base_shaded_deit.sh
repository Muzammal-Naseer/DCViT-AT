...
for ATTACK in 'pgd'; do
  evaluation 'img3d_shaded' "deit_base_patch16_224_timeP_1_cat" "mvcnn"  "" "$ATTACK" -1 20 16 "all" "pretrained_video_models/transformation/1_8split_cat_prompt/img3d_shaded/deit/12_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/mvcnn/mvcnn_shaded/model-00029.pth"
done

for ATTACK in 'pgd'; do
  evaluation 'img3d_shaded' "deit_small_patch16_224_timeP_1" "mvcnn"  "" "$ATTACK" -1 20 16 "all" "pretrained_video_models/transformation/1_8split_cat_prompt/img3d_shaded/deit_small/8_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/mvcnn/mvcnn_shaded/model-00029.pth"
done

for ATTACK in 'pgd'; do
  evaluation 'img3d_shaded' "deit_tiny_patch16_224_timeP_1" "mvcnn"  "" "$ATTACK" -1 20 16 "all" "pretrained_video_models/transformation/1_8split_cat_prompt/img3d_shaded/deit_tiny/8_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/mvcnn/mvcnn_shaded/model-00029.pth"
done
