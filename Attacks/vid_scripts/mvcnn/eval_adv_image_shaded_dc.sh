...
for ATTACK in 'mifgsm' 'pgd' 'fgsm'; do
  evaluation 'img3d_shaded' "dino_base_image" "mvcnn" "" "$ATTACK" -1 20 16 "all" "$None" "pretrained_video_models/mvcnn/mvcnn_shaded/model-00029.pth"
done

for ATTACK in 'mifgsm' 'pgd' 'fgsm'; do
  evaluation 'img3d_shaded' "clip_base_image" "mvcnn" "" "$ATTACK" -1 20 16 "all" "$None" "pretrained_video_models/mvcnn/mvcnn_shaded/model-00029.pth"
done
