...
evaluation() {
  python eval_ens.py \
    --test_dir "../../../data/drive_2/ucf101_2/annotations_1500" \
    --data_type "$1" \
    --src_model_1 "$2" \
    --tar_model "$3" \
    --image_list "$4" \
...
evaluation 'ucf101' "deit_base_patch16_224_timeP_1_cat_ens" "resnet_50"  "" "dim" -1 20 16 "all" "pretrained_video_models/transformation/1_8split_cat_prompt/ucf/deit/8_224_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/resnet_50/ucf/8_joint_1p/results/checkpoint_epoch_00030.pyth" "dino_base_patch16_224_1P_ens" "clip_base_patch16_224_1P_ens" "pretrained_video_models/transformation/1_8split_cat_prompt/ucf/dino/1_8_sample_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/transformation/1_8split_cat_prompt/ucf/clip/1_8_sample_joint_1p/results/checkpoint_epoch_00015.pyth"

# evaluation 'ucf101' "deit_base_patch16_224_timeP_1_cat" "timesformer_vit_base_patch16_224"  "" "dim" -1 20 16 "all" "pretrained_video_models/transformation/1_8split_cat_prompt/ucf/deit/8_224_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/timesformer/ucf/8_div/results/checkpoint_epoch_00015.pyth" "dino_base_patch16_224_1P" "clip_base_patch16_224_1P" "pretrained_video_models/transformation/1_8split_cat_prompt/ucf/dino/1_8_sample_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/transformation/1_8split_cat_prompt/ucf/clip/1_8_sample_joint_1p/results/checkpoint_epoch_00015.pyth"
