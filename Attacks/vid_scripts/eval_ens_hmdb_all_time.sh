...
# evaluation 'hmdb51' "deit_base_patch16_224_timeP_1_cat" "resnet_50"  "" "dim" -1 20 16 "all" "pretrained_video_models/transformation/1_8split_cat_prompt/hmdb/deit/1_8_sample_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/resnet_50/hmdb/8_joint_1p/results/checkpoint_epoch_00030.pyth" "dino_base_patch16_224_1P" "clip_base_patch16_224_1P" "pretrained_video_models/transformation/1_8split_cat_prompt/hmdb/dino/8_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/transformation/1_8split_cat_prompt/hmdb/clip/8_joint_1p/results/checkpoint_epoch_00015.pyth"

evaluation 'hmdb51' "deit_base_patch16_224_timeP_1_cat_ens" "timesformer_vit_base_patch16_224"  "" "dim" -1 20 16 "all" "pretrained_video_models/transformation/1_8split_cat_prompt/hmdb/deit/1_8_sample_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/timesformer/hmdb/8_div/results/checkpoint_epoch_00015.pyth" "dino_base_patch16_224_1P_ens" "clip_base_patch16_224_1P_ens" "pretrained_video_models/transformation/1_8split_cat_prompt/hmdb/dino/8_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/transformation/1_8split_cat_prompt/hmdb/clip/8_joint_1p/results/checkpoint_epoch_00015.pyth"
