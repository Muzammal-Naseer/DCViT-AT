...
for ATTACK in 'mifgsm' 'pgd' 'fgsm'; do
  evaluation 'hmdb51' "clip_base_image" "timesformer_vit_base_patch16_224"  "" "$ATTACK" -1 20 16 "all" "$None" "pretrained_video_models/timesformer/hmdb/8_div/results/checkpoint_epoch_00015.pyth"
done

for ATTACK in 'mifgsm' 'pgd' 'fgsm'; do
  evaluation 'hmdb51' "dino_base_image" "timesformer_vit_base_patch16_224"  "" "$ATTACK" -1 20 16 "all" "$None" "pretrained_video_models/timesformer/hmdb/8_div/results/checkpoint_epoch_00015.pyth"
done
