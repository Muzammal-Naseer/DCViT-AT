...
evaluation() {
  python eval_adv_base.py \
    --test_dir "../../../data/drive_2/ucf101_2/annotations_200" \
    --data_type "$1" \
    --src_model "$2" \
    --tar_model "$3" \
    --image_list "$4" \
...
for ATTACK in 'dim'; do
  evaluation 'ucf101' 'i3d' "timesformer_vit_base_patch16_224" "" "$ATTACK" -1 10 16 "last" "pretrained_video_models/i3d/k400/checkpoint_epoch_00120.pyth" "pretrained_video_models/timesformer/k400/8_div.pyth"
done
