...
for ATTACK in 'dim'; do
  evaluation 'ucf101' "i3d" "resnet_50" "" "$ATTACK" -1 10 16 "last" "pretrained_video_models/i3d/k400/checkpoint_epoch_00120.pyth" "pretrained_video_models/resnet_50/ucf/8_joint_1p/results/checkpoint_epoch_00015.pyth" 
done
