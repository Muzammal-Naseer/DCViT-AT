...
for ATTACK in 'dim'; do
  evaluation 'hmdb51' "dino_base_patch16_224_1P" "i3d" "" "$ATTACK" -1 20 16 "all" "pretrained_video_models/transformation/1_8split_cat_prompt/k400/k400_dino.pyth" "pretrained_video_models/i3d/hmdb/checkpoint_epoch_00120.pyth"
done
