...
evaluation() {
  python eval_adv_base.py \
    --test_dir "../../../data/drive_2/ucf101/annotations_200" \
    --data_type "$1" \
    --src_model "$2" \
    --tar_model "$3" \
    --image_list "$4" \
...
for ATTACK in 'dim'; do
  evaluation 'ucf101' "dino_base_patch16_224_1P" "i3d" "" "$ATTACK" -1 10 16 "all" "pretrained_video_models/transformation/1_8split_cat_prompt/k400/k400_dino.pyth" "pretrained_video_models/i3d/ucf/checkpoint_epoch_00120.pyth"
done
