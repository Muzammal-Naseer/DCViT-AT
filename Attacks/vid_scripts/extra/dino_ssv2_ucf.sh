...
# evaluation 'ucf101' "timesformer_vit_base_patch16_224" "timesformer_vit_base_patch16_224"  "" "dim" -1 20 16 "last" "pretrained_video_models/timesformer/k400/8_div.pyth" "pretrained_video_models/timesformer/ucf/8_div/results/checkpoint_epoch_00015.pyth"
for ATTACK in 'dim'; do
  evaluation 'ucf101' "dino_base_patch16_224_1P" "resnet_50" "" "$ATTACK" -1 20 16 "last" "pretrained_video_models/transformation/1_8split_cat_prompt/ucf/dino/1_8_sample_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/resnet_50/ucf/8_joint_1p/results/checkpoint_epoch_00030.pyth"
done
