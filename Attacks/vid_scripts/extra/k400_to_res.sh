...
evaluation() {
  python eval_adv_base.py \
    --test_dir "../../../data/drive_2/repos/datasets/kinetics-dataset/k400_resized/annotations_1500" \
    --data_type "$1" \
    --src_model "$2" \
    --tar_model "$3" \
    --image_list "$4" \
...
for ATTACK in 'dim'; do
  evaluation 'kinetics' "timesformer_vit_base_patch16_224" "resnet_50" "" "$ATTACK" -1 10 16 "last" "pretrained_video_models/timesformer/k400/8_div.pyth" "pretrained_video_models/resnet_50/k400/8_224_50/results/check_30.pyth"
done
