...
for ATTACK in 'dim' 'mifgsm' 'fgsm' 'pgd'; do
  evaluation 'ucf101' "timesformer_vit_base_patch16_224" "resnet_50" "" "$ATTACK" -1 10 16 "last" "pretrained_video_models/timesformer/ucf/8_div/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/resnet_50/ucf/8_joint_1p/results/checkpoint_epoch_00030.pyth"
done
