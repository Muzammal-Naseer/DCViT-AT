...
for ATTACK in 'dim' 'mifgsm' 'fgsm' 'pgd'; do
  evaluation 'kinetics' "resnet_50" "timesformer_vit_base_patch16_224" "" "$ATTACK" -1 10 16 "last" "pretrained_video_models/resnet_50/k400/8_224_50/results/check_30.pyth" "pretrained_video_models/timesformer/k400/8_div.pyth"
done
