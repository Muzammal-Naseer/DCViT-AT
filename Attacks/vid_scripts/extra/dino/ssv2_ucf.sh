...
for ATTACK in 'dim'; do
  evaluation 'ucf101' "dino_base_patch16_224_1P" "timesformer_vit_base_patch16_224" "" "$ATTACK" -1 20 16 "all" "pretrained_video_models/transformation/1_8split_cat_prompt/ssv2/ssv2_dino.pyth" "pretrained_video_models/timesformer/ucf/8_div/results/checkpoint_epoch_00015.pyth"
done
