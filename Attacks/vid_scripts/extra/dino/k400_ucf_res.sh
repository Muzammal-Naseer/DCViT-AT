...
for ATTACK in 'dim'; do
  evaluation 'ucf101' "dino_base_patch16_224_1P" "resnet_50" "" "$ATTACK" -1 20 16 "all" "pretrained_video_models/transformation/1_8split_cat_prompt/k400/k400_dino.pyth" "pretrained_video_models/resnet_50/ucf/8_joint_1p/results/checkpoint_epoch_00030.pyth"
done
