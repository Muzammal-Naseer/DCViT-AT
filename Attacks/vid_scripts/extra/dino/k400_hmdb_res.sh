...
for ATTACK in 'dim'; do
  evaluation 'hmdb51' "dino_base_patch16_224_1P" "resnet_50" "" "$ATTACK" -1 20 16 "all" "pretrained_video_models/transformation/1_8split_cat_prompt/k400/k400_dino.pyth" "pretrained_video_models/resnet_50/hmdb/8_joint_1p/results/checkpoint_epoch_00030.pyth"
done
