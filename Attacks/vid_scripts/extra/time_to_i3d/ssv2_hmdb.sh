...
for ATTACK in 'dim'; do
  evaluation 'hmdb51' "timesformer_vit_base_patch16_224" "i3d" "" "$ATTACK" -1 10 16 "last" "pretrained_video_models/timesformer/ssv2/8_div.pyth" "pretrained_video_models/i3d/hmdb/checkpoint_epoch_00120.pyth"
done
