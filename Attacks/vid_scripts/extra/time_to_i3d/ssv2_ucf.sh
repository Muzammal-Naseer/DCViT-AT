...
for ATTACK in 'dim'; do
  evaluation 'ucf101' "timesformer_vit_base_patch16_224" "i3d" "" "$ATTACK" -1 10 16 "last" "pretrained_video_models/timesformer/ssv2/8_div.pyth" "pretrained_video_models/i3d/ucf/checkpoint_epoch_00120.pyth"
done
