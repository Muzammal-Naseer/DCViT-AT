...
evaluation 'hmdb51' "deit_base_patch16_224_timeP_1_cat" "resnet_50"  "" "dim" -1 20 16 "all" "pretrained_video_models/transformation/1_8split_cat_prompt/hmdb/deit/1_8_sample_joint_1p/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/resnet_50/hmdb/8_joint_1p/results/checkpoint_epoch_00030.pyth"
