...
for ATTACK in 'mifgsm' 'pgd' 'fgsm'; do
  evaluation 'ucf101' "clip_base_image" "timesformer_vit_base_patch16_224"  "" "$ATTACK" -1 20 16 "all" "$None" "pretrained_video_models/timesformer/ucf/8_div/results/checkpoint_epoch_00015.pyth"
done

for ATTACK in 'mifgsm' 'pgd' 'fgsm'; do
  evaluation 'ucf101' "dino_base_image" "timesformer_vit_base_patch16_224"  "" "$ATTACK" -1 20 16 "all" "$None" "pretrained_video_models/timesformer/ucf/8_div/results/checkpoint_epoch_00015.pyth"
done
# evaluation 'ucf101' "dino_base_image" "timesformer_vit_base_patch16_224"  "" "fgsm" -1 20 16 "all" "$None" "pretrained_video_models/timesformer/ucf/8_div/results/checkpoint_epoch_00015.pyth"
