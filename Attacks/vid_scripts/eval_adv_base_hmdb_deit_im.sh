...
evaluation 'hmdb51' "deit_base_image" "timesformer_vit_base_patch16_224" "" "dim" -1 20 16 "all" "$None" "pretrained_video_models/timesformer/hmdb/8_div/results/checkpoint_epoch_00015.pyth"

# for ATTACK in 'fgsm' 'mifgsm' 'pgd' 'dim'; do
#   evaluation 'hmdb51' "deit_base_image" "timesformer_vit_base_patch16_224" "" "$ATTACK" -1 20 16 "all" None "pretrained_video_models/timesformer/hmdb/8_div/results/checkpoint_epoch_00015.pyth"
# done

# for ATTACK in 'dim' 'mifgsm' 'pgd' 'fgsm'; do
#   evaluation 'hmdb51' "deit_small_image" "timesformer_vit_base_patch16_224" "" "$ATTACK" -1 20 16 "all" None "pretrained_video_models/timesformer/hmdb/8_div/results/checkpoint_epoch_00015.pyth"
# done

# for ATTACK in 'dim' 'mifgsm' 'pgd' 'fgsm'; do
#   evaluation 'hmdb51' "deit_tiny_image" "timesformer_vit_base_patch16_224" "" "$ATTACK" -1 20 16 "all" None "pretrained_video_models/timesformer/hmdb/8_div/results/checkpoint_epoch_00015.pyth"
# done
