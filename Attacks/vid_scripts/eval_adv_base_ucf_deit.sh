...
for ATTACK in 'dim'; do
  evaluation 'ucf101' "deit_base_patch16_224_timeP_1_cat" "resnet_50"  "" "$ATTACK" -1 20 16 "all" "../timesformer/TimeSformer/train_output/196_cat_prompt/ucf/deit/8_4blocks/results/checkpoint_epoch_00015.pyth" "pretrained_video_models/resnet_50/ucf/8_joint_1p/results/checkpoint_epoch_00030.pyth"
done
