...
from imtt.datasets.multigrid_helper import ShortCycleBatchSampler
...
def construct_loader(cfg, split, is_precise_bn=False, si=0):
    """
    ...
    dataset = build_dataset(dataset_name, cfg, split, si=si)
